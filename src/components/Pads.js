...
class Pads extends Component {
    ...
    playSound = (e) => {
        const sample = document.getElementById(e.target.firstElementChild.id);
    ...
    render() {
        ...
        <div id="pads">
          ...
          S</div>
          <div id="open-hat" className="drum-pad" onClick={this.playSound}>
          ...
          X</div>
          <div id="closed-hat" className="drum-pad" onClick={this.playSound}>
